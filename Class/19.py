...
# Tkinter is a standard GUI (Graphical User Interface) library for Python. It provides
# a simple way to create windows, buttons, labels, and other GUI elements. 
# Example of a simple Tkinter application
# from tkinter import *
# def click_me():
#     print("Button Clicked!")
# root = Tk()
# root.iconbitmap("Class/icon.png") 
# root.title("My First GUI")
# root.configure(bg="white")
# root.geometry("400x300+0+0")


# bt1=Button(root, text="Click Me!", bg="blue", fg="black", font=("Arial", 16), command=click_me)
# bt1.pack(pady=20)
